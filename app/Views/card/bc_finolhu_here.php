...
<head>
    ...
    /* Social icons color */
    .facebook.finolhu a i, .twitter.finolhu a i, .youtube.finolhu a i, .instagram.finolhu a i {
        color: #38a8bb;
    }
    .facebook.here a i, .twitter.here a i, .youtube.here a i, .instagram.here a i {
        color: #c1b4aa;
    }
    </style>
</head>
<body>
    ...
    <div class="text-center mt-3">
        ...
        <div class="mt-3 d-flex justify-content-center gap-2">
            ...
            <button type="button" class="btn btn-secondary" id="copyLinkBtnFinolhu" style="width: 140px; height: 40px;">
    ...
    <div class="text-center mt-3">
        ...
        <div class="mt-3 d-flex justify-content-center gap-2">
            ...
            <button type="button" class="btn btn-secondary" id="copyLinkBtnHere" style="width: 140px; height: 40px;">
                <span class="bi bi-copy align-middle"></span> <span class="align-middle">Copy Link</span>
            </button>
        </div>
    </div>
